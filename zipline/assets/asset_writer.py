...
class AssetDBWriter(with_metaclass(ABCMeta)):
    ...
    input datatypes by implementing the gen_data method.
    ...
    gen_data(self, equities, futures, exchanges, root_symbols)
    ...
    def write_all(self, db_conn, fuzzy_char=None, allow_sid_assignment=True,
        ...
        equities, futures, exchanges, root_symbols = self.gen_data()
    ...
    def _write_exchanges(self, exchanges, db_conn):
        ...
        exchanges.to_sql('futures_exchanges', db_conn, if_exists='append',
    ...
    @abstractmethod
    def gen_data(self, equities, futures, exchanges, root_symbols):
        """
...
class AssetDBWriterLegacy(AssetDBWriter):
    ...
    def write_all(self,
        ...
        # Write to SQL tables.
        for sid, metadata in self.gen_data(self._data):
